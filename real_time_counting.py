...
object_counting_api.targeted_object_counting(input_video, detection_graph, category_index, is_color_recognition_enabled, 'person', 50, width, height) # targeted objects counting
